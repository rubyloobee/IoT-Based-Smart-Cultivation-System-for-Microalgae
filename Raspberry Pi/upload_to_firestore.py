...
# CHANGE TO YOUR FIRESTORE SERVICE ACCOUNT JSON FILE (Used for authentication)
SERVICE_ACCOUNT_FILE = "/home/bee/Firebase/smart-microalgae-cultivation-firebase-adminsdk-fbsvc-9bbb9d4d62.json"

# Path to the JSON file you want to upload
# CHANGE IF NECESSARY
JSON_FILE_PATH = "/home/bee/Firebase/sensor_data.json"

# The Firestore path where the data should be saved.
