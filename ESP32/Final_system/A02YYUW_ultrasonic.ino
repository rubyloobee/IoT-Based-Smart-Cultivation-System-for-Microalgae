...
// Configuration
float TANK_HEIGHT = 15.5;    // CHANGE TO YOUR TANK HEIGH IN CM

// --- Variables ---
float waterLevelReadings[NUM_SAMPLES];
float waterLevelAvg = 0.0;
static int bufferIndex = 0;     // Current index for circular buffer

// Setup function for the A02YYUW sensor
void setupUltrasonicSensor() {
  // SERIAL_8N1: UART configuration setting (8 data bits, no parity bit, 1 stop bit)
